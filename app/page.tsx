        ...
        <motion.div style={{ opacity: contentOpacity, y: contentY }}>
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="my-12 md:my-20 pt-20 md:pt-32 text-center">
              ...
              <p className="text-black font-light text-base sm:text-lg md:text-xl leading-relaxed max-w-3xl mx-auto">
            ...
            <div className="my-12 md:my-20 flex flex-col md:flex-row items-start gap-10 md:gap-16 lg:gap-24">
              ...
              <div className="w-full md:w-1/2 text-left">
                ...
                <div className="space-y-5 md:space-y-6 text-base sm:text-lg font-light text-gray-700 leading-relaxed">
                  <p>
                  ...
                  <div className="flex flex-wrap gap-3 sm:gap-4">
                    {skills.map((skill) => (
                      <div
                        ...
                        className="bg-gray-200 text-gray-800 px-4 py-2 sm:px-5 sm:py-2.5 rounded-lg text-sm sm:text-base transition-transform duration-300 hover:scale-110"
                      >
                        {skill}
                      </div>
                    ))}
